...
The first credential request restores the static editor’s account state, including pending sign-in callbacks, so expired LVCE tokens can refresh. Initialization is shared across polling requests.
